...
Note inorder to use this script you must place the auth-ldap.pl & auth-ldap.conf in your openldap config directory (Usually /etc/openvpn).  You must also set the following in your server.conf
